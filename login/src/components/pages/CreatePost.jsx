...
import {
  ...
  PreviewSection,
  PreviewTitle,
} from './Styled_components/CreatePost.styled'
...
function CreatePost() {
  ...
  const handleSubmit = () => {
    ...
    alert('Post created successfully! (This will be sent to backend)')
    navigate('/feed')
  }
      ...
      <PostCard>
        ...
        <PostHeader>
          ...
          <UserInfo>
            ...
            <PostVisibility>🌍 Public</PostVisibility>
          </UserInfo>
        </PostHeader>
        ...
        <PreviewSection>
          ...
          <PostCard>
            <PostHeader>
              ...
              <UserInfo>
                <UserName>{user?.name}</UserName>
                <PostVisibility>Just now • 🌍 Public</PostVisibility>
              </UserInfo>
            </PostHeader>
